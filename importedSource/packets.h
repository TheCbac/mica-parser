...
//    #define packets_ERR_SHIFT_MODULE         (6u)     /**< An invalid module was specified */
    ...
    ***************************************/
    ...
    typedef struct {
        ...
        uint32_t (*ackCallback)(packets_PACKET_S* ackPacket);     /**< Function to call when a packet was acknowledged */
        uint32_t (*cmdCallback)(packets_PACKET_S* cmdPacket, packets_PACKET_S* rspPacket);     /**< Function that gets called when a command was received */
    ...
    ***************************************/
    ...
    uint32_t packets_handleCmdPacket(packets_BUFFER_FULL_S* packet);
